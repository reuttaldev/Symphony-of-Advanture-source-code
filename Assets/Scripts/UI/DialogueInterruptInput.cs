...
namespace Yarn.Unity
{
    ...
    /// </para>
    /// </remarks>
    public class DialogueInterruptInput : MonoBehaviour
    {
        /// <summary>
        ...
        [SerializeField]
        public InterruptActionType continueActionType = InterruptActionType.KeyCode;
        [SerializeField]
        public KeyCode interruptActionKeyCode = KeyCode.Space;
        ...
        internal void Start()
        {
            ...
            if (Action != null)
            {
                Action.performed += UserPerformedInterruptAction;
...
#if USE_INPUTSYSTEM && ENABLE_INPUT_SYSTEM
        private void UserPerformedInterruptAction(InputAction.CallbackContext obj)
        {
            dialogueView.UserRequestedViewInterrupt();
        }
#endif
        ...
        internal void Update()
        {
            ...
            // lines.
            if (continueActionType != InterruptActionType.KeyCode)
            {
                return;
            }

            // Has the keycode been pressed this frame?
            if (Input.GetKeyUp(interruptActionKeyCode))
            {
