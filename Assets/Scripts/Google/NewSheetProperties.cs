...
{
    [HideInInspector]
    public string[] columnTitles = new string[]
{
    "CET Time stamp", "Export Event ID", "Track ID", "Annotation", "Interaction ID",
    "Interaction Name", "User Name", "Device ID", "Game Session", "Configuration ID",
    "Build ID", "Time of Day"
};
