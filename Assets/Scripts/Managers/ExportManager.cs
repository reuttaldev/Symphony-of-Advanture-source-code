...
public class ExportManager : SimpleSingleton<ExportManager>, IRegistrableService
{
    ...
    {
        List<object> dataToExport = CollectAndCheckData(trackData, dialogueData.UniqueGloablID,dialogueData.interactionName, dialogueData.emotionToInvoke.ToString(), lastDialogueNode);
