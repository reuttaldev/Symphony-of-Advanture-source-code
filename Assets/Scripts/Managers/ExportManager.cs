...
public class ExportManager : SimpleSingleton<ExportManager>, IRegistrableService
{
    ...
    {
        List<object> dataToExport = CollectAndCheckData(trackData, dialogueData.ID,dialogueData.interactionName, dialogueData.emotionToInvoke.ToString(), lastDialogueNode);
